...
oc->hmeasgen_NeutralPulls_part_0_param_0->Fit("gaus");
	...
	hrejects->SetTitle(" #pi^{0} Rejected Events");
	...
	TH1D* hneutE = new TH1D("hneutE","photon energy",100,0,12.0);
	TTreeReader my2dvecReaderExtra1(tree);
  	TTreeReaderValue<std::vector<std::vector<double> > > my2dvecvarExtra1(my2dvecReaderExtra1,"measNeutralParamVec");
  	while(my2dvecReaderExtra1.Next()){
		hneutE->Fill(my2dvecvarExtra1->at(0).at(0));
	...
	TTreeReader my2dvecReaderExtra2(tree);
  	TTreeReaderValue<std::vector<std::vector<double> > > my2dvecvarExtra2(my2dvecReaderExtra2,"measNeutral_err");
  	while(my2dvecReaderExtra2.Next()){
		hneutErr->Fill(my2dvecvarExtra2->at(0).at(0));
		hneutErr->Fill(my2dvecvarExtra2->at(1).at(0));
	}
	...
	TTreeReader my2dvecReaderExtra3(tree);
  	TTreeReaderValue<std::vector<std::vector<double> > > my2dvecvarExtra3(my2dvecReaderExtra3,"fitNeutral_err");
  	while(my2dvecReaderExtra3.Next()){
		hneutFitErr->Fill(my2dvecvarExtra3->at(0).at(0));
		hneutFitErr->Fill(my2dvecvarExtra3->at(1).at(0));
	}
