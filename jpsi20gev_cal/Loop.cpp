...
void Loop(){
  ...
  OutputClass* oc = new OutputClass();
	...
	TH1D* hcharErr = new TH1D("hcharErr","charged curvature errors",100,0,0.005);
	...
	TH1D* hcharFitErr = new TH1D("hcharFitErr","charged curvature fit errors",100,0,0.005);
	...
	TCanvas* fitmeas = new TCanvas();
	oc->hfitmeas_ChargedPulls_part_0_param_0->Draw();
